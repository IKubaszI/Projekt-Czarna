...
ensure_location_data_files(BACKUP_DIR)  # Upewnij się że pliki istnieją
...
if __name__ == "__main__":
    ...
    # Uruchomienie serwera
>>>>>>> parent of 0d0b1eb (Zwiększono wysokość okna zarządzania bazą i dodano automatyczne tworzenie launcher_db_config.json)
=======
"""
============================================================================
Aplikacja: Edytor Mapy Katastralnej
...
if __name__ == "__main__":
    ...
    # Uruchomienie serwera
>>>>>>> parent of ef81700 (Automatyczne tworzenie wymaganych plików JSON dla miejscowości)
